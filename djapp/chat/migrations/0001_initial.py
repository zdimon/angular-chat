...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('duration', models.IntegerField(verbose_name='Duration (min)', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('gender', models.CharField(default=b'm', max_length=1, verbose_name='Gender', choices=[(b'm', 'Man'), (b'w', 'Woman')])),
                ('user_id', models.CharField(max_length=64, verbose_name='User ID', blank=True)),
                ('name', models.CharField(max_length=128, verbose_name='Public name', blank=True)),
                ('age', models.IntegerField(default=0, max_length=2, verbose_name='Age')),
                ('email', models.CharField(max_length=128, verbose_name='E-Mail', blank=True)),
                ('country', models.CharField(max_length=64, verbose_name="User's country", blank=True)),
                ('city', models.CharField(max_length=64, verbose_name="User's city", blank=True)),
                ...
                ('culture', models.CharField(max_length=3, verbose_name='Users language code', choices=[(b'ru', b'Russian'), (b'en', 'English'), (b'ua', b'Ukrainian'), (b'fr', 'French'), (b'sp', 'Spain'), (b'de', 'German')])),
                ('is_online', models.IntegerField(default=0, max_length=1, verbose_name='Is user online now', db_index=True, choices=[(0, 'No'), (1, 'Yes')])),
